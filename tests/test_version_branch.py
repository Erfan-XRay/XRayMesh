...
class VersionAndBranchTests(unittest.TestCase):
    ...
    def test_get_version_info_fetches_from_beta_branch(self):
        fake_remote_payload = {
            "version": "2.2.6-beta.7",
            "release_name": "XRayMesh v2.2.6-beta.7",
        ...
        self.assertEqual(v_info["current_version"], "2.2.6-beta.6")
        self.assertEqual(v_info["latest_version"], "2.2.6-beta.7")
